...
- [x] Require the CSRF token on /signout to prevent forced-logout cross-site attacks.
- [x] Track signed-out sessions server-side so stolen tokens cannot outlive logout until natural expiry.

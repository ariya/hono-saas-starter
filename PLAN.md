...
- [ ] Pin the Oat CDN assets to an exact version and add Subresource Integrity hashes, so a compromised CDN cannot inject script into the credential-entry pages.
